...
for event in events:
    ...
    # Now compute top quark mass
    for bj in range(0, len(bjets_p4) ) :
      for lj in range(0, len(ljets_p4) ) :
        for kj in range(lj+1, len(ljets_p4) ):
          wP4 = ljets_p4[lj] + ljets_p4[kj]
          topP4 = bjets_p4[bj] + ljets_p4[lj] + ljets_p4[kj]
          print(" W mass : {0:6.2f} GeV/c2").format( wP4.M() ) 
          print(" t mass : {0:6.2f} GeV/c2").format( topP4.M() )
